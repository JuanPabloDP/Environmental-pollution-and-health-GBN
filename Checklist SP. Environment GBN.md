...
-   [x] Investiguen un poco sobre cómo se relacionan los contaminantes del aire, y cómo y a qué biomarcadores impactan. (Miguel)
    -   [x] Con ayuda de compañerxs o profesorxs de medicina y química realicen lo siguiente:
        -   [x] Conseguir Experto 1
        -   [x] Conseguir Experto 2
...
-   [x] Ajusten una GBN para cada una de las DAG propuestas. (Camila)
    -   [x] DAG1
    -   [x] DAG2
    -   [x] DAG3
-   [x] Reporten el BIC y el AIC para cada GBN. (Camila)
    -   [x] DAG1
    -   [x] DAG2
    -   [x] DAG3
